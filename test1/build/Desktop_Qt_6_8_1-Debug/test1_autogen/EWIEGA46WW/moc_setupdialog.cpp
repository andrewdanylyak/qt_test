...
static constexpr auto qt_meta_stringdata_ZN11SetupDialogE = QtMocHelpers::stringData(
    "SetupDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11SetupDialogE[] = {
...
Q_CONSTINIT const QMetaObject SetupDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11SetupDialogE.offsetsAndSizes,
    qt_meta_data_ZN11SetupDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11SetupDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SetupDialog, std::true_type>
    >,
    nullptr
} };
...
void *SetupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11SetupDialogE.stringdata0))
